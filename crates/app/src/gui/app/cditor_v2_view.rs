...
pub struct CditorV2View {
    ...
    pub(in crate::gui::app) ai_models: Vec<cditor_ai::AiModelDescriptor>,
    pub(in crate::gui::app) selected_ai_model_id: Option<String>,
    pub(in crate::gui::app) ai_model_menu_open: bool,
    pub(in crate::gui::app) ai_model_scroll_handle: gpui::ScrollHandle,
