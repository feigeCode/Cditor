...
│   └── cditor-cli/
├── scripts/
│   ├── archive/workspace-migration/fix_imports.sh    ✅ 第一轮路径修复（已归档）
│   └── archive/workspace-migration/fix_imports_2.sh  ✅ 第二轮路径修复（已归档）
└── doc/
...
# 修复导入路径
./scripts/archive/workspace-migration/fix_imports.sh
./scripts/archive/workspace-migration/fix_imports_2.sh
